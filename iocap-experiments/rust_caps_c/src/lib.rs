...
pub unsafe extern "C" fn ccap_perms_str(perms: CCapPerms) -> *const core::ffi::c_char {
    match perms {
        CCapPerms::Read => "CCapPerms::Read\0".as_ptr() as *const core::ffi::c_char,
        CCapPerms::Write => "CCapPerms::Write\0".as_ptr() as *const core::ffi::c_char,
        CCapPerms::ReadWrite => "CCapPerms::ReadWrite\0".as_ptr() as *const core::ffi::c_char,
    }
}
...
pub unsafe extern "C" fn ccap_result_str(res: CCapResult) -> *const core::ffi::c_char {
    match res {
        CCapResult::Success => "CCapResult::Success\0".as_ptr() as *const core::ffi::c_char,
        CCapResult::Encode_UnrepresentableBaseRange => {
            "CCapResult::Encode_UnrepresentableBaseRange\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Encode_UnrepresentableCaveat => {
            "CCapResult::Encode_UnrepresentableCaveat\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Encode_InvalidCaveat => {
            "CCapResult::Encode_InvalidCaveat\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Encode_NoCaveatsLeft => {
            "CCapResult::Encode_NoCaveatsLeft\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Encode_CantShrinkPerms => {
            "CCapResult::Encode_CantShrinkPerms\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Decode_InvalidCaveat => {
            "CCapResult::Decode_InvalidCaveat\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Decode_InvalidSignature => {
            "CCapResult::Decode_InvalidSignature\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Decode_InvalidCapPermsChain => {
            "CCapResult::Decode_InvalidCapPermsChain\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Decode_UnexpectedCaveat => {
            "CCapResult::Decode_UnexpectedCaveat\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Encode_TooBigSecretId => {
            "CCapResult::Encode_TooBigSecretId\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Encode_InvalidPerms => {
            "CCapResult::Encode_InvalidPerms\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::Decode_NotVirtio => {
            "CCapResult::Decode_NotVirtio\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::NullRequiredArgs => {
            "CCapResult::NullRequiredArgs\0".as_ptr() as *const core::ffi::c_char
        }
        CCapResult::CatastrophicFailure => {
            "CCapResult::CatastrophicFailure\0".as_ptr() as *const core::ffi::c_char
        }
    }
}
