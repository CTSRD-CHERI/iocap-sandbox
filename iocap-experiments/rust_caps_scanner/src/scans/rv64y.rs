use rust_cheri_compressed_cap::{caps::rvy::cc128, CcxCap, CompressedCapability};
...
pub const RV64Y_BASE_ALIGN: BaseAlign<CcxCap<Cap>> =
    basic_cap::BaseAlign::<CcxCap<Cap>>::new(!0, Some(1u128 << 64));
pub const RV64Y_LENGTH_PRECISION: LengthPrecision<CcxCap<Cap>> =
