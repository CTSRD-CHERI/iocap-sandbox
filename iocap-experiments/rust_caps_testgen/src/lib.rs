...
pub fn gen_in_category<R: Rng>(rng: &mut R, cap: CapVariant, category: RandomCategory, initial_len_pow2: Option<u8>) -> CapTestCase {
    match (cap, category) {
        (CapVariant::Cap2024_02, RandomCategory::Valid0Cav) => Cap2024_02::<Aes128HandrolledSig>::rand_0cav_cap(rng, None, None, initial_len_pow2, None),
        (CapVariant::Cap2024_02, RandomCategory::Valid1Cav) => Cap2024_02::<Aes128HandrolledSig>::rand_1cav_cap(rng, None, None, initial_len_pow2, None),
        (CapVariant::Cap2024_02, RandomCategory::Valid2Cav) => Cap2024_02::<Aes128HandrolledSig>::rand_2cav_cap(rng, None, None, initial_len_pow2, None),
        (CapVariant::Cap2024_11, RandomCategory::Valid0Cav) => Cap2024_11::<Aes128HandrolledSig>::rand_0cav_cap(rng, None, None, initial_len_pow2, None),
        (CapVariant::Cap2024_11, RandomCategory::Valid1Cav) => Cap2024_11::<Aes128HandrolledSig>::rand_1cav_cap(rng, None, None, initial_len_pow2, None),
        (CapVariant::Cap2024_11, RandomCategory::Valid2Cav) => Cap2024_11::<Aes128HandrolledSig>::rand_2cav_cap(rng, None, None, initial_len_pow2, None),
    }
}
