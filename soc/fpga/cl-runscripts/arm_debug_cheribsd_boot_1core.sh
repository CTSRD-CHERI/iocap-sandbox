...
{
  ls -l $VIRTIO_FS
  $BASEPATH/sws35-stuff/tinyemu-virtio/src/fmem_virtio_host --block $VIRTIO_FS --block $VIRTIO_BLANK_FS --debug-log >$BASEPATH/sws35-stuff/tinyemu.stdout 2>$BASEPATH/sws35-stuff/tinyemu.stderr
}

GDB_PORT=81
# BBL=$BASEPATH/riscv-freebsd-boot/bbl-dual-cheri
# DEVICETREE=$BASEPATH/riscv-freebsd-boot/devicetree.virtio.dual.wrapped.elf
BBL=$BASEPATH/riscv-freebsd-boot/bbl-cheri
...
sleep 5
echo "DEBUG MODE - WILL BOOT CHERIBSD BUT CANT INTERACT"
